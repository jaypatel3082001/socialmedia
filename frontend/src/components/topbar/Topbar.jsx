  ...
  const handleClick = async (e) => {
    ...
    try {
      const res = await axios
        .get(`users/user/findOne/${searchdata}`)
        .then((data) => {
  ...
  return (
    <div className="topbarContainer">
        ...
        <div className="topbarCenter">
          <div className="searchbar">
            ...
            <input
              ...
              onChange={(e) => [handleChange(e), setSearchUser("")]}
            />
      ...
      {searchUser && searchdata && (
          <div className="containerSearchSpace">
        <div className="searchspace">
            ...
            <span className="searchusername">{searchUser.username}</span>
        </div>
          </div>
      )}
      <div
      ...
      >
        <div
          ...
          style={{ position: open === true ? "absolute" : "" }}
        >
        ...
        {open && (
          <div className="menu-sidebar">
            <ul>
              <li onClick={toggleOtheroption} className="nav-item">
                Other Option
              </li>
              <hr/>
              <li onClick={toggleOnlineFriends} className="nav-item">
                Online friend
              </li>
              <hr/>

              <li onClick={toggleLogout} className="nav-item">
                <button className="jk">LOGOUT</button>
              </li>
            </ul>
          </div>
        )}
